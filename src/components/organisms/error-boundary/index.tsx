...
const errorDescription = (status?: number) => {
  const defaultDescription =
    "An error occurred with unspecified causes, this is most likely due to a technical issue on our end. Please try refreshing the page. If the issue keeps happening, contact your administrator."
  ...
  const description = {
    ...
    500: "The server was not able to handle your request, this is mostly likely due to a technical issue on our end. Please try again. If the issue keeps happening, contact your administrator.",
